...
class CarrefourScraper(BaseScraper):
    def __init__(self):
        super().__init__()
        self.supermercado = "Carrefour"
        self.api_url = "https://www.carrefour.com.ar/api/catalog_system/pub/products/search/"
        self.headers = {
            ...
            if resp.status_code in (200, 206):
                ...
                if data and len(data) > 0:
                    ...
                    try:
                        ...
                        print(f"[CarrefourScraper] Estructura JSON no esperada: {e}")
                        
        except Exception as e:
            print(f"[CarrefourScraper] Error buscando {termino_busqueda}: {e}")
